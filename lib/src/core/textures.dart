...
class TextureProperties {
  ...
  void InstallEarly(FlutterWGL cgl, int type) {
    cgl.pixelStorei(GL_UNPACK_FLIP_Y_WEBGL, flipY ? 1 : 0);
  }

  // This assumes a texture is already bound
  void InstallLate(FlutterWGL cgl, int type) {
...
class TypedTexture extends Texture {
  TypedTexture(FlutterWGL cgl, String url, this._width, this._height,
...
class TypedTextureMutable extends Texture {
  TypedTextureMutable(FlutterWGL cgl,
      String url,
      this._width,
      this._height,
...
class ImageTexture extends Texture {
  ImageTexture(FlutterWGL cgl, String url, this._element,
...
class CubeTexture extends Texture {
  CubeTexture(FlutterWGL cgl, String url, List images)
      : super(
