...
*/
  ...
  static Texture createParticleTexture(FlutterWGL cgl,
  ...
  static Material MakeStarMaterial(FlutterWGL cgl, [double size = 1000.0]) {
...
class RenderPhaseResizeAware extends RenderPhase {
  RenderPhaseResizeAware(
      String name, FlutterWGL cgl, this._canvas, this._perspective)
      : super(name, cgl) {
