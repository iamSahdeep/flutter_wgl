...
Texture MakeSolidColorTexture(FlutterWGL cgl, String url, String fillStyle) {
  return ImageTexture(cgl, url, MakeSolidColorCanvas(fillStyle));
}

Texture MakeSolidColorTextureRGB(FlutterWGL cgl, String url, VM.Vector3 rgb) {
...
Texture MakeSolidColorTextureRGBA(FlutterWGL cgl, String url, VM.Vector4 rgba) {
